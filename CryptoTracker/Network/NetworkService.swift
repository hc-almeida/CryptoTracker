...
final class NetworkService {
    ...
    private func requestList<Model: Decodable>(url: URL, completion: @escaping (Result<[Model], NetworkError>) -> Void) {
    ...
    func requesAllIcons(completion: @escaping (Result<[Icon], NetworkError>) -> Void) {
